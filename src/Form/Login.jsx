...
const Login = () => {
    ...
    return (
      ...
      <form onSubmit={handlesubmit} className="space-y-6" action="#">
        <h5 className="text-[30px] font-bold text-[#1AACAC]  dark:text-white text-center">Login your account</h5>

       


        <div>
          <label htmlFor="email" className="block mb-2    dark:text-white  text-[#fff] font-semibold text-[20px]">Email address</label>
          <input
            type="email"
            name="email"
            // ref={emailRef}
        ...
        <div>
          <label htmlFor="password" className="block mb-2   text-[#fff] font-semibold text-[20px]dark:text-white ">Password</label>
          <input
        ...
        <div className="flex items-start">
          <div className="flex items-start">
            ...
            <label htmlFor="remember" className="ml-2 text-sm font-medium text-[#fff] dark:text-gray-300">Remember me</label>
          </div>
          <button className="ml-auto text-sm hover:underline dark:text-blue-500 text-[#1AACAC] ">Lost Password?</button>
        </div>
        <button
          type="submit"
